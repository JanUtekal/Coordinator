...
CREATE FUNCTION postgis_scripts_build_date() RETURNS text
    ...
    AS $$SELECT '2011-10-02 11:32:22'::text AS version$$;
...
--
-- Name: centraluser; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
ALTER TABLE public.centraluser OWNER TO postgres;
...
--
-- Name: mapobject; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
CREATE SEQUENCE mapobject_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE mapobject_id_seq OWNED BY mapobject.id;
...
--
-- Name: point; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
--
-- Name: polygon; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
--
-- Name: terrainuser; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
--
-- Name: usercentral_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE usercentral_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.usercentral_id_seq OWNER TO postgres;

--
-- Name: usercentral_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE usercentral_id_seq OWNED BY centraluser.id;


--
-- Name: userposition; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
ALTER TABLE public.userposition OWNER TO postgres;

--
-- Name: userposition_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE userposition_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.userposition_id_seq OWNER TO postgres;

--
-- Name: userposition_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE userposition_id_seq OWNED BY userposition.id;
...
ALTER TABLE centraluser ALTER COLUMN id SET DEFAULT nextval('usercentral_id_seq'::regclass);
...
ALTER TABLE mapobject ALTER COLUMN id SET DEFAULT nextval('mapobject_id_seq'::regclass);
...
ALTER TABLE userposition ALTER COLUMN id SET DEFAULT nextval('userposition_id_seq'::regclass);
...
--
-- Name: mapobject_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY mapobject
...
--
-- Name: point_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--
...
--
-- Name: polygon_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--
...
--
-- Name: usercentral_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY centraluser
    ADD CONSTRAINT usercentral_pkey PRIMARY KEY (id);


--
-- Name: userposition_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--
...
--
-- Name: Message_cantraluser_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY message
    ADD CONSTRAINT "Message_cantraluser_fkey" FOREIGN KEY (centraluser) REFERENCES centraluser(id) ON UPDATE SET NULL ON DELETE SET NULL;


--
-- Name: Message_terrainuser_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY message
    ADD CONSTRAINT "Message_terrainuser_fkey" FOREIGN KEY (terrainuser) REFERENCES terrainuser(id) ON UPDATE SET NULL ON DELETE SET NULL;


--
-- Name: acl_usercentral_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY acl
    ADD CONSTRAINT acl_usercentral_fkey FOREIGN KEY (centraluser) REFERENCES centraluser(id);


--
-- Name: mapobject_acl_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY mapobject
    ADD CONSTRAINT mapobject_acl_fkey FOREIGN KEY (acl) REFERENCES acl(id);


--
-- Name: userposition_terrainuser_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY userposition
    ADD CONSTRAINT userposition_terrainuser_fkey FOREIGN KEY (terrainuser) REFERENCES terrainuser(id);


--
-- Name: userposition_useracl_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY userposition
    ADD CONSTRAINT userposition_useracl_fkey FOREIGN KEY (useracl) REFERENCES acl(id);


--
-- Name: userterrain_acl_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY terrainuser
    ADD CONSTRAINT userterrain_acl_fkey FOREIGN KEY (acl) REFERENCES acl(id);
